class Game {
  ...
  start() {
    ...
    var obstacle1Positions = [
      ...
      { x: width / 2 - 160, y: height - 1300, image: obstacle1Image },
      { x: width / 2 + 240, y: height - 1800, image: obstacle1Image },
      { x: width / 2 - 210, y: height - 3300, image: obstacle1Image },
    ...
    var obstacle2Positions = [
      { x: width / 2 - 190, y: height - 1300, image: obstacle2Image },
      { x: width / 2 + 140, y: height - 1800, image: obstacle2Image },
      { x: width / 2 - 180, y: height - 3300, image: obstacle2Image },
      { x: width / 2 - 170, y: height - 1400, image: obstacle1Image },
      { x: width / 2 + 230, y: height - 1900, image: obstacle1Image },
      { x: width / 2 - 200, y: height - 3400, image: obstacle1Image },
